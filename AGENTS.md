...
Before further steak work, read `operations/14-STEAK-ARTWORK-CONTINUATION-2026-09-12.md`. Daniel approved the final illustration in chat with “This is the one!”. Preserve that exact original; do not regenerate it or substitute an earlier review. At this continuation, its exact binary and filename are still unresolved: the documentation commit is not an image upload. The reported fixed-template crop partly hid the potato behind the QR and remained review-only. Keep illustration approval, derivative/crop approval and verified GitHub publication separate. Preserve the supplied-screenshot details and hand-drawn anime consistency constraints recorded in that handover; all existing brand, front, back and size locks remain unchanged.
