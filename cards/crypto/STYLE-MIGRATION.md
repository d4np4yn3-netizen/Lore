# Crypto style migration

Permanent reference: HODL v2, resolved through style-reference-lock.json.
Dan authorised restyling each card one at a time on 19 September 2026.
Workflow order below is the implementation order; it is not collector numbering.
...
Do not create new event concepts during this migration. Preserve the approved
event/copy, assigned rarity and key Easter eggs. Pizza's old raster remains
archived; use the current pinned template for a separately reviewed editable restyle.
