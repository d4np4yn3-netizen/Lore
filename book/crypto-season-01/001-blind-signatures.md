...
**Editorial status:** Chapter draft and [full-art A4 spread review](proofs/001-blind-signatures-full-art-spread-v2.pdf) ([card-front comparison](proofs/001-blind-signatures-spread-v1.pdf)), 26 September 2026. The card front, art, phrase, rarity and number are approved. Book wording, trim size and page design have not received separate approval. The QR works in the current digital scan; physical print proof remains separate.
