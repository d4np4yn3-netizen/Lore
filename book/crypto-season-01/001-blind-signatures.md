...
**Editorial status:** This chapter's story, clues and source/art note were approved for both book and website on 26 September 2026. See the [full-art A4 spread with approved copy](proofs/001-blind-signatures-full-art-spread-v3.pdf). Its page design, trim size and print reproduction remain under review. The card front, art, phrase, rarity and number are approved. The QR works in the current digital scan; physical print proof remains separate.
