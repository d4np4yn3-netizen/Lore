"""Build the two-page editorial proof for card 001 (not a print specification)."""
...
OUT = ROOT / "book/crypto-season-01/proofs/001-blind-signatures-spread-v1.pdf"
...
# Page 1 - the approved card is the hero. No page geometry is claimed as final.
...
label(c, "LORE / THE STORY", 43, H-39, BLACK)
c.setFillColor(BLACK); c.setFont("DejaVu-Bold", 28)
c.drawString(43, H-102, "THE HIDDEN MESSAGE")
c.setFillColor(GREY); c.setFont("DejaVu", 9)
c.drawString(43, H-122, "001  /  BLIND SIGNATURES  /  DAVID CHAUM")
...
label(c, "HIDDEN IN THE ART", right, H-160, BLACK, 9)
z = H-179
clues = [
